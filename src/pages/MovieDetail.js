...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=cd341abbf453afe939f9b124c3c3a1e4`);
  ...
  useEffect(() => {
    document.title = `${movie.title}- MovieWorm`;
  });

  return (
    <main>
      <section className="flex justify-center flex-wrap py-5 gap-x-10">
